    ...
    def gen_sched(optimizer, train_loader, epochs, last_epoch):
        ...
        func = piecewise_schedule(
            ...
            [
                ...
                const_schedule(1.0),
                decay_sched,
                linear_schedule(decay_sched(1.0), linear_cooldown_end_ratio),
            ],
        )
        return LambdaLR(
...
def func_scheduler(
    optimizer, func, total_steps, warmup_steps=None, warmup_ratio=0.1, start_step=0
):
    """
    ...
    if warmup_steps:
        y0 = func(0.0)
        func = piecewise_schedule(
            [warmup_steps / total_steps], [linear_schedule(warmup_ratio * y0, y0), func]
        )
