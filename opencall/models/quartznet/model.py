...
from opencall.models.common.nn import Permute, layers
...
class Model(Module):
    ...
    def ctc_label_smoothing_loss(self, log_probs, targets, lengths, weights=None):
        ...
        weights = weights or torch.cat(
            [torch.tensor([0.4]), (0.1 / (C - 1)) * torch.ones(C - 1)]
        )
        ...
        return {
            "total_loss": loss + label_smoothing_loss,
            "loss": loss,
...
class Decoder(Module):
    ...
    def __init__(self, features, classes):
        ...
        self.layers = Sequential(
            Conv1d(features, classes, kernel_size=1, bias=True), Permute([2, 0, 1])
        )
