...
def main():
    ...
    # 3. get data
    train_loader, valid_loader = get_dataset_in_one_dir(args,dist=False, encoder_only=True)
                ...
                with amp.autocast(enabled=args.use_amp):
                    for data_, targets_, lengths_ in zip(
                        *map(lambda t: t.chunk(grad_accum_split, dim=0), batch)
                        ...
                        scores_ = model(data_)
                        losses_ = model.loss(scores_, targets_)
...
def get_parser():
    ...
    parser.add_argument(
        "--data_dir", type=str, default="./train_data/data_for_encoder_only/train"
    )
    parser.add_argument("--epoch_num", type=int, default=1)
    parser.add_argument("--batch_size", type=int, default=64)
    parser.add_argument("--pre_trained_params_file", type=str, default="xxx")
    parser.add_argument("--lr", type=float, default=5e-4)
    parser.add_argument("--limit_train_size", default=100000000000, type=int)
    ...
    parser.add_argument("--model", default="lstm_encoder", type=str)
    ...
    parser.add_argument("--output_name", default="only_encoder_2", type=str)
