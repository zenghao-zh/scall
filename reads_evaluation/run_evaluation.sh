...
MODEL_DIR="/workspace/huada/task_results/lstm_ctc_crf_qat_int8"
DEVICE="cuda:0"
GPU_ID=5
OUTPUT_DIR="${SCRIPT_DIR}/results"
THREADS=4
NAME="l9_6x_0214_weights_40"
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python ${SCRIPT_DIR}/example.py \
    ...
    --decode viterbi \
    --quant --bf16 \
    --io_quant ${MODEL_DIR}/io_quant_8.pth \
    --act_scales ${MODEL_DIR}/act_scales_8.pth
